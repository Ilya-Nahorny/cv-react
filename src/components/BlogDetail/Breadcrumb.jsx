...
const Breadcrumb = ({ pages }) => {
  return (
    <div className="px-4 py-4 bg-white rounded-lg shadow-sm sm:px-6 md:px-8 md:py-5 mb-5 dark:bg-darkBgMain">
      <ul className="flex items-center">
        {pages.map((page, index) => (
          <li key={index} className="flex items-center">
            <span className="text-base font-medium text-dark dark:text-darkTextMain capitalize">
              {page}
            </span>
            {index < pages.length - 1 && (
              <span className="px-3 text-body-color dark:text-darkTextChild">
                <svg
                  width="7" 
                  height="12"
                  viewBox="0 0 7 12"
